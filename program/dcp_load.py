...
instanceTableRows = []
for instance in dcpInstanceList:
    instanceTableRows.append(
        [currentStamp, instance["Subscription"], instance["User"], instance["Name"], instance["SubType"], instance["Version"]]
    )
...
IngestRows(kustoClient, 
           ...
           configObject["Tables"]["DevControlPlane"]["Table"],
           instanceTableRows, 
           configObject["Tables"]["DevControlPlane"]["Columns"]
          )
